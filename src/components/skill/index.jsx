...
const Skills = () => {
  const skills = [
    ...
    { name: "HTML", level: "Intermediate", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/html5/html5-original.svg", percentage: 90 },
    { name: "CSS", level: "Intermediate", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/css3/css3-original.svg", percentage: 85 },
    ...
    { name: "PostgreSQL", level: "Intermediate", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/postgresql/postgresql-original.svg", percentage: 90 },
    { name: "GIT", level: "Intermediate", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/git/git-original.svg", percentage: 85 },
    { name: "GitHub", level: "Intermediate", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/github/github-original.svg", percentage: 85 }, 
    { name: "Docker", level: "Intermediate", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/docker/docker-original.svg", percentage: 80 },
      ...
      <div className="container mx-auto px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 gridCol5 gap-8">
          ...
          {skills.map((skill, index) => (
            ...
            // </div>
            <Atropos key={index} highlight={false} shadowScale={1.05} rotateXMax={10} rotateYMax={10}>
            <div className="skill-item flex flex-col items-center justify-center text-center">
              ...
              <h3 className="text-2xl font-semibold mt-4" data-atropos-offset="8">{skill.name}</h3>
              <p className="text-gray-400 mb-4">{skill.level}</p>
              <div className="w-full bg-[#094A73] rounded-full h-4 overflow-hidden mb-4">
                <div
                  ref={addToRefs}
